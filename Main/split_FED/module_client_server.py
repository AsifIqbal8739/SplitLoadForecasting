...
class Client(torch.nn.Module):
    ...
    def client_backward(self, grad_from_server_encoder, grad_from_server_decoder_x, grad_from_server_decoder_trend1):
...
class Server(torch.nn.Module):
    ...
    def forward(self, interm_to_server_encoder, interm_to_server_decoder_x,
        ...
        outputs_encoder, _ = self.server_encoder(self.interm_to_server_encoder)

        output_x, output_res_trend = self.server_decoder(self.interm_to_server_decoder_x, outputs_encoder,
                                                         self.interm_to_server_decoder_trend1)
